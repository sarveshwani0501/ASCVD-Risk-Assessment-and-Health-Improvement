...
//     // Add registration API call or further processing
//   };
...
const SignUp = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log(response.data);
      // Show confirmation popup after successful registration
  ...
  // Handle confirmation popup close and redirect to login
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4 sm:p-6 lg:p-8">
      ...
      {/* Account Created Confirmation Popup */}
      {showConfirmation && (
